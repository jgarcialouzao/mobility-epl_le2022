...
log using logs/desc1w.log, replace	
...
*Define var lists
global wcovs   "female age spanish college"
...
esttab orig* initial res* using ../Tables/descall_wlevel.tex, replace cells("mean(fmt(a3))") label booktabs nonum gaps f 
